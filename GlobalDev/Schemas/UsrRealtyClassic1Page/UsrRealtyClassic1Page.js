define("UsrRealtyClassic1Page", ["ServiceHelper"], function(ServiceHelper) {
	return {
		...
		details: /**SCHEMA_DETAILS*/{
			...
			"UsrSchema7e14e98bDetail6c87fd68": {
		...
		businessRules: /**SCHEMA_BUSINESS_RULES*/{
			"UsrComment": {
				"ec03c315-24aa-42dc-aef3-9683f07c3a99": {
					"uId": "ec03c315-24aa-42dc-aef3-9683f07c3a99",
					"enabled": true,
					"removed": false,
					"ruleType": 0,
					"property": 0,
			...
			"UsrManager": {
				"4b3f1f56-3e34-4011-9d70-ef590f4e5fd8": {
					"uId": "4b3f1f56-3e34-4011-9d70-ef590f4e5fd8",
					"enabled": false,
					"removed": false,
					"ruleType": 1,
		...
		methods: {
			...
			onMyButtonClick: function() {
				...
				this.set("UsrManager", contactObject);
		...
		diff: /**SCHEMA_DIFF*/[
			{
				"operation": "insert",
				"name": "UsrNamee9d04278-1250-4a0d-91e2-ce6d1b8ee886",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT7a6f2eed-0ad0-45fe-afdb-a318af8615fa",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOATc60de906-5e53-45ee-bb3e-020f470df202",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "FLOAT8c3ac6c5-6282-448e-8e05-d3723d9cbbe6",
				"values": {
					"layout": {
						"colSpan": 24,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUP29307253-1414-4fb4-95c9-719e71199749",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "LOOKUPc4e0229a-7cd0-4d2b-bb4b-901919acc042",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "STRINGc32b5c6d-1df6-4833-bd4c-f4dc010a78cd",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 2,
			...
			{
				"operation": "insert",
				"name": "UsrManagere164f300-8d64-44d7-b7c8-8debece35bb1",
				"values": {
					"layout": {
						"colSpan": 12,
						"rowSpan": 1,
			...
			{
				"operation": "insert",
				"name": "Tab7b600de7TabLabel",
				"values": {
					"caption": {
						"bindTo": "Resources.Strings.Tab7b600de7TabLabelTabCaption"
					},
					"items": [],
					"order": 0
				},
			...
			{
				"operation": "insert",
				"name": "UsrSchema7e14e98bDetail6c87fd68",
				"values": {
					"itemType": 2,
					"markerValue": "added-detail"
				},
				"parentName": "Tab7b600de7TabLabel",
				"propertyName": "items",
				"index": 0
			},
			{
